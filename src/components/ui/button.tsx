...
const buttonVariants = cva(
  [
    ...
    "transition-[background-color,border-color,box-shadow,transform,color] duration-100 ease-out",
    ...
    variants: {
      variant: {
        ...
        secondary: [
          ...
          "hover:shadow-[var(--control-lift-hover)]",
          "active:shadow-none aria-expanded:bg-secondary",
        ],
        /**
        ...
        link: [
          ...
          "shadow-none hover:decoration-primary active:translate-y-0",
        ],
      },
      size: {
        default:
